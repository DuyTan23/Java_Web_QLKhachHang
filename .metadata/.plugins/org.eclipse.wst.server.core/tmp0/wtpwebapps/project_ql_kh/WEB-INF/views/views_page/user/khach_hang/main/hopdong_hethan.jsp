				...
				<div class="grid__row">
					...
					<div class="grid__column-9-5">
						<div class="manage__main-menu">
							<h2 class="manage__main-heading">Danh sách khách hàng hết
								hạn bảo trì chưa kí hợp đồng</h2>
							<h2>${iddonvi }</h2>
						...
						<div class="manage__grid-client">
							<table class="manage__grid-table table-bordered">
								<tr class="manage__grid-tablerow">
									...
									<th class="manage__grid-tableheader">Loại dịch vụ</th>
									<th class="manage__grid-tableheader">Ngày ký hợp đồng</th>
									<th class="manage__grid-tableheader">Ngày hết hạn hợp đồng</th>
								</tr>
								...
								<c:forEach items="${khachhang }" var="kh">
									...
									<tr class="manage__grid-tablerow">
										...
										<td class="manage__grid-tabledata">${kh[5] }</td>
										<td class="manage__grid-tabledata">${kh[6] }</td>
										<td class="manage__grid-tabledata">${kh[7] }</td>
