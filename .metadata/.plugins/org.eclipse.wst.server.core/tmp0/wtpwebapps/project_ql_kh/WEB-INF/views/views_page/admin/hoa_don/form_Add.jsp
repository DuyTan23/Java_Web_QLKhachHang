			...
			<div class="grid">
				<div class="detail">
					...
					<div class="detail__data">
						...
						<form:form action="saveAddHoaDon" modelAttribute="hoadon">
							<div class="detail__data-grid">
								...
								<div class="detail__data-list">
									...
									<label class="detail__item"> <input type="radio" name="option" value="true"> Đã thanh toán</label > 
									<label class="detail__item"> <input type="radio" name="option"value="false"> Chưa thanh toán</label>
								</div>
