			...
			<div class="grid">
				<div class="detail">
					<div class="detail__header">
						...
						<div class="detail__header-heading">Thêm khách hàng mới</div>
					</div>

					<div class="detail__data">

						<form:form action="saveAddKhachHang" modelAttribute="khachhang">
								...
								<div class="detail__data-list">
									<div class="detail__data-list">
										<form:button href="" class="detail-btn"> <i
											class="fa-solid fa-plus detail-icon"></i> Thêm
										</form:button>
									</div>
								</div>
