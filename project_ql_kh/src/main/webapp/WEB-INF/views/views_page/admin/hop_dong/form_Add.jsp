			...
			<div class="grid">
				<div class="detail">
					<div class="detail__header">
						...
						<div class="detail__header-heading">Thêm hợp đồng mới</div>
					</div>

					<div class="detail__data">

						<form:form action="saveAddHopDong" modelAttribute="hopdong">
							<div class="detail__data-grid">
								...
								<div class="detail__data-list">
									...
									<form:input path="giatri" type="number" cssClass="detail__item" />
								</div>

								<div class="detail__data-list">
									<label for="" class="detail__data-label">Hiện trạng hóa đo</label>
									<label class="detail__item"> <input type="radio" name="option" value="true">
										Đã xuất
									</label > <label class="detail__item"> <input type="radio" name="option"
